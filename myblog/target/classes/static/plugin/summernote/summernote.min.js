/*! Summernote v0.7.1 | (c) 2013-2015 Alan Hong and other contributors | MIT license */ ! function(a) {
	"function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ?
		module.exports = a(require("jquery")) : a(window.jQuery)
}(function(a) {
	"use strict";
	var b, c = function() {
			var b = function(a) {
	...
	var j = {
		...
		m = function() {
			var b = function(b) {
				...
				E = function(a, b) {
					b = b || c.ok;
					var d = [];
					return a.previousSibling && b(a.previousSibling) && d.push(a.previousSibling), d.push(a), a.nextSibling && b(a.nextSibling) &&
						d.push(a.nextSibling), d
				},
				...
				H = function(a) {
					var b = G(a);
					return 0 === b ? !0 : g(a) || 1 !== b || a.innerHTML !== F ? d.all(a.childNodes, g) && "" === a.innerHTML ? !0 :
						!1 : !0
				},
				I = function(a) {
				...
				ka = function(a, b) {
					for (var c = a, d = 0, e = b.length; e > d; d++) c = c.childNodes.length <= b[d] ? c.childNodes[c.childNodes.length -
						1] : c.childNodes[b[d]];
					return c
				},
				la = function(a, b) {
		...
		n = function(b, e) {
			...
			return this.memos = {}, this.modules = {}, this.layoutInfo = {}, this.options = e, this.initialize = function() {
				...
				return void 0 === a ? (this.invoke("codeview.sync"), c ? this.layoutInfo.codable.val() : this.layoutInfo.editable
					.html()) : (c ? this.layoutInfo.codable.val(a) : this.layoutInfo.editable.html(a), b.val(a), this.triggerEvent(
					"change", a), void 0)
				...
				this.invoke("codeview.isActivated") && this.invoke("codeview.deactivate"), this.layoutInfo.editable.attr(
					"contenteditable", !1), this.invoke("toolbar.deactivate", !0)
				...
				d.shouldInitialize = d.shouldInitialize || c.ok, d.shouldInitialize() && (d.initialize && d.initialize(), d.events &&
					m.attachEvents(b, d.events))
			}, this.module = function(a, b, c) {
				return 1 === arguments.length ? this.modules[a] : (this.modules[a] = new b(this), void(c || this.initializeModule(
					a)))
			}, this.removeModule = function(a) {
				var c = this.modules[a];
				c.shouldInitialize() && (c.events && m.detachEvents(b, c.events), c.destroy && c.destroy()), delete this.modules[
					a]
				...
				return function(d) {
					d.preventDefault(), f.invoke(b, c || a(d.target).data("value") || a(d.currentTarget).data("value"))
				}
	...
	a.summernote = a.summernote || {
		...
		summernote: function() {
			...
			f = a.extend({}, a.summernote.options, f), f.langInfo = a.extend(!0, {}, a.summernote.lang["en-US"], a.summernote
				.lang[f.lang]), this.each(function(b, c) {
				var d = a(c);
	...
	var o = function(b, c, d, e) {
			this.render = function(f) {
				var g = a(b);
				if (d && d.contents && g.html(d.contents), d && d.className && g.addClass(d.className), d && d.data && a.each(d.data,
						function(a, b) {
							g.attr("data-" + a, b)
		...
		v = p.create(['<div class="note-statusbar">', '  <div class="note-resizebar">', '    <div class="note-icon-bar"/>',
			'    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', "  </div>", "</div>"
		].join("")),
		...
		A = p.create('<div class="dropdown-menu">', function(b, c) {
			var d = a.isArray(c.items) ? c.items.map(function(a) {
				return '<li><a href="#" data-value="' + a + '">' + a + "</a></li>"
			}).join("") : c.items;
			b.html(d)
		}),
		B = p.create('<div class="dropdown-menu note-check">', function(b, c) {
			var d = a.isArray(c.items) ? c.items.map(function(a) {
				return '<li><a href="#" data-value="' + a + '">' + F(c.checkClassName) + " " + a + "</a></li>"
			}).join("") : c.items;
			b.html(d)
		}),
		C = p.create('<div class="note-color-palette"/>', function(a, b) {
			for (var c = [], d = 0, e = b.colors.length; e > d; d++) {
				for (var f = b.eventName, g = b.colors[d], h = [], i = 0, j = g.length; j > i; i++) {
					var k = g[i];
					h.push(['<button type="button" class="note-color-btn"', 'style="background-color:', k, '" ', 'data-event="', f,
						'" ', 'data-value="', k, '" ', 'title="', k, '" ', 'data-toggle="button" tabindex="-1"></button>'
					].join(""))
				}
		...
		D = p.create('<div class="modal" aria-hidden="false"/>', function(a, b) {
			a.html(['<div class="modal-dialog">', '  <div class="modal-content">', b.title ?
				...
				b.title + "</h4>    </div>" : "", '    <div class="modal-body">' + b.body + "</div>", b.footer ?
				'    <div class="modal-footer">' + b.footer + "</div>" : "", "  </div>", "</div>"
			].join(""))
		}),
		E = p.create(['<div class="note-popover popover bottom in">', '  <div class="arrow"/>',
		...
		G = {
			...
			createLayout: function(a, b) {
				var c = (b.airMode ? G.airEditor([G.editingArea([G.airEditable()])]) : G.editor([G.toolbar(), G.editingArea([G.codable(),
					G.editable()
				]), G.statusbar()])).render();
	...
	var H, I = function() {
		...
		J = function() {
			var b = function(a, b) {
					...
					for (c = 0; c < h.length; c++)
						...
						for (var l = k.text.replace(/[\r\n]/g, "").length; l > j.nodeValue.length && j.nextSibling;) l -= j.nodeValue.length,
							j = j.nextSibling;
						j.nodeValue;
						b && j.nextSibling && m.isText(j.nextSibling) && l === j.nodeValue.length && (l -= j.nodeValue.length, j = j.nextSibling),
							f = j, c = l
					}
					return {
						cont: f,
				...
				f = function(b, g, h, i) {
					...
					this.getPoints = function() {
						...
						return a[0].scrollTop + a.height() < this.sc.offsetTop && (a[0].scrollTop += Math.abs(a[0].scrollTop + a.height() -
							this.sc.offsetTop)), this
					}, this.normalize = function() {
						var a = function(a, b) {
								if (m.isVisiblePoint(a) && !m.isEdgePoint(a) || m.isVisiblePoint(a) && m.isRightEdgePoint(a) && !b || m.isVisiblePoint(
										a) && m.isLeftEdgePoint(a) && b || m.isVisiblePoint(a) && m.isBlock(a.node) && m.isEmpty(a.node)) return a;
								var c = m.ancestor(a.node, m.isBlock);
								if ((m.isLeftEdgePointOf(a, c) || m.isVoid(m.prevPoint(a).node)) && !b || (m.isRightEdgePointOf(a, c) || m.isVoid(
										m.nextPoint(a).node)) && b) {
						...
						return m.walkPoint(g, h, function(b) {
							if (!m.isEditable(b.node)) {
								var c;
								f ? (m.isLeftEdgePoint(b) && j.push(b.node), m.isRightEdgePoint(b) && d.contains(j, b.node) && (c = b.node)) :
									c = e ? m.ancestor(b.node, a) : b.node, c && a(c) && i.push(c)
							}
						}, !0), d.unique(i)
						...
						var a = b === h,
							c = this.getPoints();
						return m.isText(h) && !m.isEdgePoint(this.getEndPoint()) && h.splitText(i), m.isText(b) && !m.isEdgePoint(this.getStartPoint()) &&
							(c.sc = b.splitText(g), c.so = 0, a && (c.ec = c.sc, c.eo = i - g)), new f(c.sc, c.so, c.ec, c.eo)
					...
					this.isOnEditable = l(m.isEditable), this.isOnList = l(m.isList), this.isOnAnchor = l(m.isAnchor), this.isOnCell =
						l(m.isCell), this.isLeftEdgeOf = function(a) {
							...
							if (m.isBodyContainer(b) && m.isEmpty(b)) return b.innerHTML = m.emptyPara, new f(b.firstChild, 0, b.firstChild,
								0);
			...
			return {
				create: function(a, c, d, e) {
					if (arguments.length) 2 === arguments.length && (d = a, e = c);
						...
						var n = b(l, !0),
							o = b(k, !1);
						m.isText(n.node) && m.isLeftEdgePoint(n) && m.isTextNode(o.node) && m.isRightEdgePoint(o) && o.node.nextSibling ===
							n.node && (n = o), a = n.cont, c = n.offset, d = o.cont, e = o.offset
					}
				...
				createFromNode: function(a) {
					var b = a,
						...
						d = a,
						e = m.nodeLength(d);
					return m.isVoid(b) && (c = m.listPrev(b).length - 1, b = b.parentNode), m.isBR(d) ? (e = m.listPrev(d).length -
						1, d = d.parentNode) : m.isVoid(d) && (e = m.listPrev(d).length, d = d.parentNode), this.create(b, c, d, e)
				},
		...
		M = function() {
			...
			this.fromNode = function(a) {
				...
				return d.anchor = b.isOnAnchor() && m.ancestor(b.sc, m.isAnchor), d.ancestors = m.listAncestor(b.sc, m.isEditable),
					d.range = b, d
			}
		},
		N = function() {
			this.insertOrderedList = function() {
				...
				return a.each(b, function(b, f) {
					...
					f = c ? m.listDescendant(k, m.isLi) : d.from(k.childNodes).filter(m.isLi), (c || !m.isList(i.parentNode)) && (
						f = f.map(function(a) {
		...
		R = function(b) {
			...
			this.initialize = function() {
				g.on("keydown", function(a) {
					a.keyCode === I.code.ENTER && b.triggerEvent("enter", a), b.triggerEvent("keydown", a), h.shortcuts && !a.isDefaultPrevented() &&
						c.handleKeyMap(a)
				}).on("keyup", function(a) {
				...
				g.on(a, function() {
					...
					}), !h.airMode && h.height && g.outerHeight(h.height), !h.airMode && h.maxHeight && g.css("max-height", h.maxHeight),
					!h.airMode && h.minHeight && g.css("min-height", h.minHeight), g.html(m.html(e) || m.emptyPara), p.recordUndo()
			}, this.destroy = function() {
				g.off()
			...
			for (var q = this.beforeCommand = function() {
				...
				}, s = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft",
					"justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "foreColor",
					"fontName"
				], t = 0, u = s.length; u > t; t++) this[s[t]] = function(a) {
				return function(b) {
			...
			this.tab = function() {
			...
			}), b.memo("help.insertOrderedList", i.help.insertOrderedList), this.insertUnorderedList = this.wrapCommand(
				function() {
				...
				return K.createImage(a, c).then(function(a) {
					q(), "function" == typeof c ? c(a) : ("string" == typeof c && a.attr("data-filename", c), a.css("width", Math.min(
						g.width(), a.width()))), a.show(), J.create().insertNode(a[0]), J.createFromNodeAfter(a[0]).select(), r()
				}).fail(function() {
				...
				a.each(d, function(a, d) {
					var e = d.name;
					h.maximumImageFileSize && h.maximumImageFileSize < d.size ? b.triggerEvent("image.upload.error", i.image.maximumFileSizeError) :
						K.readFileAsDataURL(d).then(function(a) {
			...
			this.fontSize = function(b) {
				...
				if (c && c.isCollapsed()) {
					...
					a(e).css({
						"font-size": b + "px"
					}), f && !m.nodeLength(f) && (f.innerHTML = m.ZERO_WIDTH_NBSP_CHAR, J.createFromNodeAfter(f.firstChild).select(),
						g.data(Q, f))
				...
				if (a) {
					var b = d.find(d.from(a.childNodes), m.isText),
						c = b.nodeValue.indexOf(m.ZERO_WIDTH_NBSP_CHAR); - 1 !== c && b.deleteData(c, 1), m.isEmpty(a) && m.remove(a),
						g.removeData(Q)
				}
				...
				g.is(":focus") || (g.focus(), !g.is(":focus") && j.isFF && J.createFromNode(g[0]).normalize().collapse().select())
		...
		S = function(b) {
			...
			this.events = {
				"summernote.keydown": function(a, d) {
					c.needKeydownHook() && (d.ctrlKey || d.metaKey) && d.keyCode === I.code.V && (b.invoke("editor.saveRange"), c.$paste
				...
				if (m.isImg(c)) {
					for (var d = c.src, e = atob(d.split(",")[1]), f = new Uint8Array(e.length), g = 0; g < e.length; g++) f[g] = e.charCodeAt(
						g);
					var h = new Blob([f], {
						type: "image/png"
					});
					h.name = "clipboard.png", b.invoke("editor.restoreRange"), b.invoke("editor.focus"), b.invoke(
						"editor.insertImagesOrCallback", [h])
				} else {
				...
				if (c && c.items && c.items.length) {
					...
					"file" === e.kind && -1 !== e.type.indexOf("image/") && b.invoke("editor.insertImagesOrCallback", [e.getAsFile()]),
		...
		T = function(b) {
			...
			this.initialize = function() {
				...
				c.on("dragenter", function(a) {
					...
					c || f.length || !e || (d.addClass("dragover"), h.width(d.width()), h.height(d.height()), i.text(g.image.dragImageHere)),
						f = f.add(a.target)
					...
					d && d.files && d.files.length ? (c.preventDefault(), e.focus(), b.invoke("editor.insertImagesOrCallback", d.files)) :
	...
	var U = function(a) {
			...
			this.sync = function() {
				...
				if (d.val(m.html(c, e.prettifyHtml)), d.height(c.height()), a.invoke("toolbar.updateCodeview", !0), b.addClass(
						"codeview"), d.focus(), j.hasCodeMirror) {
				...
				var g = m.value(d, e.prettifyHtml) || m.emptyPara,
					h = c.html() !== g;
				c.html(g), c.height(e.height ? d.height() : "auto"), b.removeClass("codeview"), h && a.triggerEvent("change", c.html(),
					c), c.focus(), a.invoke("toolbar.updateCodeview", !1)
			}, this.destroy = function() {
			...
			this.initialize = function() {
				f.airMode || f.disableResizeEditor || d.on("mousedown", function(a) {
					...
					c.on("mousemove", function(a) {
						var c = a.clientY - (b + V);
						c = f.minheight > 0 ? Math.max(c, f.minheight) : c, c = f.maxHeight > 0 ? Math.min(c, f.maxHeight) : c, e.height(
							c)
		...
		Y = function(b) {
			...
			this.events = {
				...
				this.$handle = a(['<div class="note-handle">', '<div class="note-control-selection">',
					'<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>',
					'<div class="note-control-holder note-control-ne"></div>',
					'<div class="note-control-holder note-control-sw"></div>', '<div class="', f.disableResizeImage ?
					"note-control-holder" : "note-control-sizing", ' note-control-se"></div>', f.disableResizeImage ? "" :
					'<div class="note-control-selection-info"></div>', "</div>", "</div>"
				].join("")).prependTo(e), this.$handle.on("mousedown", function(a) {
		...
		Z = function(b) {
			var c = this,
				e = /^(https?:\/\/|ssh:\/\/|ftp:\/\/|file:\/|www\.|(?:mailto:)?[A-Z0-9._%+-]+@)(.+)$/i;
			this.events = {
				...
				if (this.lastWordRange) {
					var a = this.lastWordRange.toString();
					if (e.test(a)) {
						var c = this.nodeFromKeyword(a);
						this.lastWordRange.insertNode(c), this.lastWordRange = null, b.invoke("editor.focus")
					}
				}
			}, this.nodeFromKeyword = function(b) {
				return a("<a />").html(b).attr("href", b)[0]
		...
		aa = function(b) {
			var e = this,
				...
				l = this.representShortcut = function(a) {
					var b = k[a];
					return j.isMac && (b = b.replace("CMD", "⌘").replace("SHIFT", "⇧")), b = b.replace("BACKSLASH", "\\").replace(
						"SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]"), " (" + b + ")"
				};
			this.initialize = function() {
				...
				b.memo("button.style", function() {
					...
					return f.buttonGroup({
						...
						children: [f.button({
							...
							items: ["<li>", '<div class="btn-group">', '  <div class="note-palette-title">' + i.color.background +
								"</div>", "  <div>",
								'    <button class="note-color-reset btn btn-default" data-event="backColor" data-value="inherit">',
								i.color.transparent, "    </button>", "  </div>",
								'  <div class="note-holder" data-event="backColor"/>', "</div>", '<div class="btn-group">',
								'  <div class="note-palette-title">' + i.color.foreground + "</div>", "  <div>",
								'    <button class="note-color-reset btn btn-default" data-event="removeFormat" data-value="foreColor">',
								i.color.resetToDefault, "    </button>", "  </div>",
								'  <div class="note-holder" data-event="foreColor"/>', "</div>", "</li>"
							].join(""),
							callback: function(b) {
		...
		ba = function(b) {
			...
			this.shouldInitialize = function() {
				...
				f.toolbar = f.toolbar || [], f.toolbar.length ? b.invoke("buttons.build", e, f.toolbar) : e.hide(), d.on(
		...
		ca = function(b) {
			...
			this.initialize = function() {
				var b = f.dialogsInBody ? a(document.body) : e,
					c = '<div class="form-group"><label>' + g.link.textToDisplay +
					'</label><input class="note-link-text form-control" type="text" /></div><div class="form-group"><label>' + g.link
					.url + '</label><input class="note-link-url form-control" type="text" value="http://" /></div>' + (f.disableLinkTarget ?
						"" : '<div class="checkbox"><label><input type="checkbox" checked> ' + g.link.openInNewWindow +
						"</label></div>"),
				...
				return a.Deferred(function(a) {
					...
					d.onDialogShown(c.$dialog, function() {
						b.triggerEvent("dialog.shown"), f.val(e.text), f.on("input", function() {
							...
							}).val(e.url).trigger("focus"), c.bindEnterKey(g, h), c.bindEnterKey(f, h), i.prop("checked", e.isNewWindow),
		...
		ea = function(b) {
			...
			this.initialize = function() {
				...
				var j = '<div class="form-group note-group-select-from-files"><label>' + g.image.selectFromFiles +
					'</label><input class="note-image-input form-control" type="file" name="files" accept="image/*" multiple="multiple" />' +
					c + '</div><div class="form-group" style="overflow:auto;"><label>' + g.image.url +
				...
				b.invoke("editor.saveRange"), this.showImageDialog().then(function(a) {
					d.hideDialog(c.$dialog), b.invoke("editor.restoreRange"), "string" == typeof a ? b.invoke("editor.insertImage",
						a) : b.invoke("editor.insertImagesOrCallback", a)
				}).fail(function() {
					b.invoke("editor.restoreRange")
				})
		...
		ga = function(b) {
			...
			this.initialize = function() {
				var b = f.dialogsInBody ? a(document.body) : e,
					c = '<div class="form-group row-fluid"><label>' + g.video.url + ' <small class="text-muted">' + g.video.providers +
				...
				if (e && 11 === e[1].length) {
					var v = e[1];
					c = a("<iframe>").attr("frameborder", 0).attr("src", "//www.youtube.com/embed/" + v).attr("width", "640").attr(
						"height", "360")
				} else if (g && g[0].length) c = a("<iframe>").attr("frameborder", 0).attr("src", g[0] + "/embed/").attr("width",
					"612").attr("height", "710").attr("scrolling", "no").attr("allowtransparency", "true");
				else if (i && i[0].length) c = a("<iframe>").attr("frameborder", 0).attr("src", i[0] + "/embed/simple").attr(
					"width", "600").attr("height", "600").attr("class", "vine-embed");
				else if (k && k[3].length) c = a("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr(
					"frameborder", 0).attr("src", "//player.vimeo.com/video/" + k[3]).attr("width", "640").attr("height", "360");
				else if (m && m[2].length) c = a("<iframe>").attr("frameborder", 0).attr("src",
					"//www.dailymotion.com/embed/video/" + m[2]).attr("width", "640").attr("height", "360");
				else if (o && o[1].length) c = a("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr(
					"frameborder", 0).attr("height", "498").attr("width", "510").attr("src", "//player.youku.com/embed/" + o[1]);
				else {
					if (!(q || s || u)) return !1;
		...
		ha = function(b) {
			...
			this.createShortCutList = function() {
				...
				return Object.keys(c).forEach(function(e) {
					var f = a('<div class="help-list-item"/>'),
						g = c[e],
						h = b.memo("help." + g) ? b.memo("help." + g) : g,
						i = a("<label />").css({
							width: 180,
							"max-width": 200,
							"margin-right": 10
						...
						j = a("<span />").html(h);
					f.html(i).append(j), d.append(f)
				}), d.html()
			}, this.initialize = function() {
				var b = f.dialogsInBody ? a(document.body) : e,
					c = ['<p class="text-center">', '<a href="//summernote.org/" target="_blank">Summernote 0.7.1</a> · ',
						'<a href="//github.com/summernote/summernote" target="_blank">Project</a> · ',
						'<a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"
					].join("");
				this.$dialog = d.dialog({
		...
		ja = function(b) {
			...
			this.events = {
				...
				}).render().appendTo("body"), this.$content = this.$popover.find(".popover-content"), this.$content.on("click",
					".note-hint-item",
					function() {
				...
				this.$content.find(".active").removeClass("active"), a.addClass("active"), this.$content[0].scrollTop = a[0].offsetTop -
				...
				var a = this.$content.find(".note-hint-item.active"),
					c = this.nodeFromItem(a);
				this.lastWordRange.insertNode(c), J.createFromNode(c).collapse().select(), this.lastWordRange = null, this.hide(),
					b.invoke("editor.focus")
			}, this.nodeFromItem = function(a) {
				var b = h[a.data("index")],
					c = a.data("item"),
				...
				this.$popover.is(":visible") && (a.keyCode === I.code.ENTER ? (a.preventDefault(), this.replace()) : a.keyCode ===
					I.code.UP ? (a.preventDefault(), this.moveUp()) : a.keyCode === I.code.DOWN && (a.preventDefault(), this.moveDown())
				)
				...
				if (d.contains([I.code.ENTER, I.code.UP, I.code.DOWN], a.keyCode)) {
					...
					if (h.length && g) {
						this.$content.empty();
						var i = c.rect2bnd(d.last(f.getClientRects()));
						i && (this.$popover.css({
							left: i.left,
							top: i.top + i.height
						}).hide(), this.lastWordRange = f, h.forEach(function(a, b) {
							a.match.test(g) && e.createGroup(b, g).appendTo(e.$content)
						}))
					} else this.hide()
				}
			}, this.show = function() {
